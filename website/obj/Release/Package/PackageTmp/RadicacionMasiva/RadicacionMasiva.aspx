...
<head runat="server">
    ...
    <%--    <script type="text/javascript">
        $(function () {
            setTimeout(function () {
            $('#fuFiles').uploadify({
                'uploader': 'FileUploads.aspx',
                'script': 'FileUploads.aspx',
                'cancelImg': 'image/cancel.png',
                'auto': 'true',
                'multi': 'true',
                'buttonText': 'Seleccioneee...',
                'queueSizeLimit': 50
            });
            }, 10);
        });
    ...
    <script runat="server">
        ...
        void BtnSelectImgs_Click(object sender, System.EventArgs e)
        {
            ...
            HttpPostedFile uploads = Request.Files["fileUpload"];
    ...
    <form id="form1" runat="server" enctype="multipart/form-data">
        ...
        <div class="rm_all_container">
            <div class="rm_header">
                ...
                <asp:LinkButton ID="LinkButton1" runat="server" Style="color: White;" OnClick="LinkButton1_Click">Consulta</asp:LinkButton>
            </div>
            <div class="rm_content">
                <div class="rm_optios_container">
                    ...
                    <div class="rm_content_paso2">
                        ...
                        <div id="div_paso2" runat="server" visible="true">
                            <%-- <div id="fuFiles" style="visibility:visible">
            
                                </div> --%>
                            <div id="fuFiles">
                                <asp:Button ID="BtnSelectImgs" runat="server" Text="Seleccione..." CssClass="btns" OnClick="BtnSelectImgs_Click" />
                                <div id="fuFiles2" class="file-upload-container">
                                    <input type="file" id="fileUpload" multiple runat="server" />
                                    <label for="fileUpload" class="upload-mask-button">Seleccione...</label>
                                </div>
                            </div>
                            <br />
                            <div>
